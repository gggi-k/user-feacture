...
public class MyInfoController {
    ...
    @PutMapping
    public void update(@RequestBody UserRequest userRequest, @AuthenticationPrincipal UserPrincipal principal) {
        userService.update(userRequest.setUserId(principal.getUserId()));
    }
}